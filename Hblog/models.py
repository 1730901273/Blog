...
class article(models.Model):
    ...
    # 实现图片的上传
    img = models.ImageField(verbose_name='图片',upload_to='article/%Y/%m/%d',default='article/default.jpg')
...
class Carousel(models.Model):
    ...
    img = models.ImageField(verbose_name=u'轮播图片',upload_to='carousel/%Y/%m/%d',default='/static/img/carousel/default.jpg')
