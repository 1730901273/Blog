...
EMAIL_HOST_USER = '1730901273@qq.com'  # 我自己的邮箱 例如: xxxxxx@163.com
EMAIL_HOST_PASSWORD = 'qxoxsyvxfgtpdjae'  # 我的邮箱密码 例如  xxxxxxxxx
EMAIL_SUBJECT_PREFIX = u'Vblog'  # 为邮件Subject-line前缀,默认是'[django]'
